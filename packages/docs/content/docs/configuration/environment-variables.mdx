...
| `ARR_INSTANCES`            | Instances            | json    | _(unset)_ | JSON array of `{ "id", "name", "type": "sonarr"\|"radarr", "url", "apiKey", "enabled", "categories" }` objects. `categories` limits the instance to those download-client categories; omit for any. _(secret)_                                                                                                                                                                                                                                             |
