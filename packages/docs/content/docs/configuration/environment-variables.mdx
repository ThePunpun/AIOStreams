...
| `ANIME_DB_SUPPRESS_SIBLING_ALIASES`                  | Anime DB › Suppress Sibling Aliases           | boolean  | `false`    | When multiple anime seasons/cours share an external ID, suppress broad show aliases from TMDB/TVDB/Trakt so they do not leak across seasons. |
...
| `BUILTIN_SCRAPE_TITLE_LIMIT`                              | Scrape › Title Limit                                | number  | `3`                     | Maximum alternative titles used per scrape when no override is configured.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `BUILTIN_SCRAPE_TITLE_LIMITS`                             | Scrape › Title Limits                               | map     | —                       | Per-indexer alternative-title limit overrides. Format: `<key>:<limit>[,<key>:<limit>...]`. Keys use the same priority as BUILTIN_SCRAPE_TITLE_LANGUAGES: exact hostname, auto-extracted Jackett/NZBHydra2 indexer name, addon ID, then `*`. Unmatched indexers fall back to BUILTIN_SCRAPE_TITLE_LIMIT.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `BUILTIN_SCRAPE_YEARLESS_MOVIE_FALLBACK_ENABLED`          | Scrape › Yearless Movie Fallback › Enabled          | boolean | `false`                 | Retry movie title searches without the year when the initial searches return too few results. May increase API usage and return broader results.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `BUILTIN_SCRAPE_YEARLESS_MOVIE_FALLBACK_RESULT_THRESHOLD` | Scrape › Yearless Movie Fallback › Result Threshold | number  | `3`                     | Minimum unique results needed to skip the yearless fallback, counted per addon (per indexer in Prowlarr) before stream filtering.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
